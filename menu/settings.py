...
SECRET_KEY = 'a55+wr3v$a9#8x28#cfp@rke(7usl0l)m5re-99&6-i^8*m-4l'
...
# Application definition (Attention il faut les ajouter à la main à chaque nouvelle appli créée)
